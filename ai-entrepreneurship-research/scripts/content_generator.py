...
BUSINESS_TEMPLATES = {
    "mental_reprogramming": {
        "cleaning": "Use alpha state visualization before client meetings to project confidence and grow ProsperClean",
        "vibe_coding": "Apply mental rehearsal before coding sessions to sharpen your creative flow",
    ...
    "book_summary": {
        "cleaning": "Apply the book's core principle to optimize ProsperClean operations and win more contracts",
        "vibe_coding": "Use the author's framework to build better AI-powered tools faster",
    ...
    "biography": {
        "cleaning": "Apply this leader's persistence to scale ProsperClean across Canberra",
        "vibe_coding": "Use their innovation mindset to vibe code your next project",
    ...
    "sales_persuasion": {
        "cleaning": "Practice this technique in your next ProsperClean service pitch",
        "vibe_coding": "Use this persuasion method when presenting your AI tools to clients",
    ...
    "ai_engineering": {
        "cleaning": "Automate ProsperClean scheduling and client communication with AI tools",
        "vibe_coding": "Use Claude Code to vibe code this technique into a working prototype today",
    ...
    "influence_charisma": {
        "cleaning": "Use charisma techniques to retain ProsperClean clients and get referrals",
        "vibe_coding": "Apply influence skills to build a personal brand as a vibe coder",
    ...
    "spirituality": {
        "cleaning": "Find purpose and meaning in service to others through ProsperClean",
        "vibe_coding": "Code with intention - align your builds with your higher purpose",
...
def generate_content(
    ...
    return {
        ...
        "business_applications": {
            ...
            "vibe_coding": biz_templates.get("vibe_coding", ""),
